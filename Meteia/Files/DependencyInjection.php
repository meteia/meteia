...
return [
    ...
    PublicUri::class => fn (Configuration $configuration): PublicUri => new PublicUri($configuration->string('METEIA_FILES_OBJECT_STORAGE_PUBLIC_URI', $configuration->string('METEIA_FILES_OBJECT_STORAGE_ENDPOINT', ''))),
