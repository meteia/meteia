...
class AddressSpec extends ObjectBehavior
{
    ...
    public function it_can_print_an_address_out()
    {
    ...
    public function it_can_get_the_recipient()
    {
        $this->getRecipient()->shouldReturnString('John');
    }

    public function it_can_get_the_street()
    {
        $this->getStreetLine()->shouldReturnString('1101 N. Wilmot Rd Ste 233');
    }

    public function it_can_get_the_street_second_line()
    {
        $this->getOccupancyLine()->shouldReturnString('');
    }

    public function it_can_get_the_city()
    {
        $this->getCity()->shouldReturnString('Tucson');
    }

    public function it_can_get_the_country()
    {
        $this->getCountry()->shouldReturnString('United States');
    }

    public function it_can_get_the_state()
    {
        $this->getState()->shouldReturnString('AZ');
    }

    public function it_can_get_the_zip()
    {
        $this->getZip()->shouldReturnString('85712');
    }

    public function it_can_get_the_zip_plus_four()
    {
        $this->getZipPlusFour()->shouldReturnString('85712-5159');
    }

    public function it_can_build_blank_address()
    {
        $this->beConstructedWith([]);
        $this->getAddress()->shouldReturnString('');
    }

    public function it_cat_get_custom_formats()
    {
    ...
    public function it_can_have_custom_separators()
    {
        $street = new Street('1101 N. Wilmot Rd Ste 233');
        $baseArray = [
            'street' => $street,
