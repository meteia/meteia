...
class ComplexStringLiteralSpec extends ObjectBehavior
{
    ...
    public function it_can_return_the_same_string()
    {
        $this->isEmpty()->shouldReturn(false);
        $this->string()->shouldReturn('test 1');
    }

    public function it_can_take_two_string_as_input()
    {
        $this->beConstructedWith('test', ' 1');
        $this->string()->shouldReturn('test 1');
    }

    public function it_can_take_string_literal_as_constructor()
    {
    ...
    public function it_can_take_string_literal_and_string_as_input()
    {
