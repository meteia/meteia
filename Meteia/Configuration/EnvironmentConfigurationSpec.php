...
class EnvironmentConfigurationSpec extends ObjectBehavior
{
    ...
    public function it_returns_defaults()
    {
    ...
    public function it_returns_from_env()
    {
    ...
    public function it_accepts_all_for_string()
    {
    ...
    public function it_throws_on_invalid_int()
    {
    ...
    public function it_throws_on_invalid_float()
    {
    ...
    public function it_throws_on_invalid_bool()
    {
