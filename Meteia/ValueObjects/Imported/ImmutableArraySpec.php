...
class ImmutableArraySpec extends ObjectBehavior
{
    ...
    public function it_can_be_created_with_an_array()
    {
        $this->beConstructedWith([new \stdClass(), new \stdClass()]);
        $this->count()->shouldEqual(2);
    }

    public function it_can_be_created_with_an_empty_array()
    {
    ...
    public function it_allows_pushing_of_valid_type()
    {
        $this->push(new \stdClass())->shouldHaveCount(1);
    }

    public function it_throws_when_pushing_an_invalid_type()
    {
        $this->shouldThrow(ImproperType::class)->during('push', [new \Exception()]);
    }

    public function it_allows_read_only_array_access()
    {
        $this->beConstructedWith([new \stdClass(), new \stdClass()]);
    ...
    public function it_prohibits_mutations()
    {
    ...
    public function it_can_be_merged_with_another_array()
    {
